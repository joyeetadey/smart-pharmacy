...
<div class="row" style="text-align: center">
    ...
    <div class="col-md-2">
        ...
        <h4><a href="gp_products.php" style="color: black">General Purpose Medicines</a></h4>
    </div>
    <div class="col-md-2">
        ...
        <h4><a href="#" style="color: black">Personal Care</a></h4>
    </div>
    <div class="col-md-2">
        <img class="rounded-circle" src="images/medical%20equipments.jpg" style="height: 150px; width: 150px"><br><br>
        <h4><a href="#" style="color: black">Medical Equipments</a></h4>
    </div>
    <div class="col-md-2">
        ...
        <h4><a href="#" style="color: black">Health Conditions</a></h4>
    </div>
    <div class="col-md-2">
        ...
        <h4><a href="#" style="color: black">Homeopathy</a></h4>
    </div>
    <div class="col-sm-1">
