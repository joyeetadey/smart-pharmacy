                ...
                <div class="card strpied-tabled-with-hover">
                    ...
                    <div class="card-body table-full-width">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $res=mysqli_query($conn,"select * from products where pharmacy_id='p101'");
                                while ($row=mysqli_fetch_array($res)){
                                    ?>
                                    <tr>
                                        <td> <?php echo $row['id'];  ?> </td>
                                        <td> <?php echo $row['med_name'];  ?> </td>
                                        <td> <?php echo $row['med_qty_type'];  ?> </td>
                                        ...
                                        <td> <?php echo $row['mfd_date'];  ?> </td>
                                        <td> <?php echo $row['category'];  ?> </td>
                                        <?php echo "<td><button class='btn btn-info'><a style='color: white' href='update.php?upd=".$row["id"]."'>Update</a></button> 
                                       <button class='btn btn-danger'><a style='color: white' href='inventory.php?del=".$row["id"]."'>Delete</a></button></td>"?>
                                    </tr>
                                    <?php
                                }
                                ?>
