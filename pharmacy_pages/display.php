...
<div class="container-fluid">
    <?php $res=mysqli_query($conn,"select * from products");?>
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <?php echo "<td><button class='btn btn-info'><a style='color: white' href='inventory.php?pdf=".$row["id"].">Delete</a></button>"?></td>
                <?php echo "<td><button class='btn btn-info'><a style='color: white' href='update.php?pdf=".$row["id"].">Update</a></button>"?></td>
            </tr>
    <?php
}
?>
